...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Для Каждого Строка Из ДанныеПлатежа Цикл
		...
		ДвижениеСведения.Количество = Строка.КоличествоЧеловек;
		ДвижениеСведения.Тариф = Строка.Тариф;
		ДвижениеСведения.Сумма = Строка.СуммаПлатежа;
		ДвижениеСведения.Норматив = Строка.Норматив;
	КонецЦикла;
	...
	Для Каждого Строка Из ДанныеПлатежа Цикл
		...
		ДвижениеПотребление.Количество = Строка.КоличествоЧеловек;		
		ДвижениеПотребление.Сумма = Строка.СуммаПлатежа;
		ДвижениеПотребление.Тариф = Строка.Тариф;
		ДвижениеПотребление.Норматив = Строка.Норматив;
	КонецЦикла;
