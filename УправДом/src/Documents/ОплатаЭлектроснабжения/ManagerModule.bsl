...
Функция ПечатьЭлектроснабжения(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Запрос.Текст =
		...
		|	ОплатаЭлектроснабжения.Поставщик.Телефон КАК ПоставщикТелефон,
		|	ОплатаЭлектроснабжения.Поставщик.ЭлектроннаяПочта КАК ПоставщикЭлектроннаяПочта,
		|	ОплатаЭлектроснабжения.Поставщик.Сайт КАК ПоставщикСайт,
