...
Процедура ОбработкаПроведения(Отказ, Режим)
   ...
   // Проверка, проведен ли текущий документ, для запрета перепрведения	
	...
	Запрос.Текст =
		"ВЫБРАТЬ ПЕРВЫЕ 1
		|	УстановкаПервичныхДанныхГазоснабжения.Представление КАК Представление
		|ИЗ
		|	Документ.УстановкаПервичныхДанныхГазоснабжения КАК УстановкаПервичныхДанныхГазоснабжения
		|ГДЕ
		|	УстановкаПервичныхДанныхГазоснабжения.Проведен
		|	И УстановкаПервичныхДанныхГазоснабжения.Ссылка <> &Ссылка";
	...
	Если Не РезультатЗапроса.Пустой() Тогда
		...
		Сообщение = Новый СообщениеПользователю();
		Сообщение.Текст = "Первичные данные газоснабжения уже установлены! Регистратор : "
