...
КонецПроцедуры
#КонецОбласти
#Область ОбработчикиСобытийЭлементовТаблицыФормыДанныеПлатежа
&НаКлиенте
Процедура ДанныеПлатежаТекущиеПоказанияПриИзменении(Элемент)
//	ТекДан = Элементы.ДанныеПлатежа.ТекущиеДанные;
//	Если ТекДан.ТекущиеПоказания < ТекДан.ПоказанияНачисления Тогда 
//		Сообщение = Новый СообщениеПользователю;
//		Сообщение.Текст = "Текущие показания не могут быть меньше показаний начисления.";
//		Сообщение.Поле = "Объект.ДанныеПлатежа.ТекущиеПоказания";
//		Сообщение.Сообщить();
//		ТекДан.ТекущиеПоказания = 0;
//		Возврат;	
//	КонецЕсли;
КонецПроцедуры
#КонецОбласти
