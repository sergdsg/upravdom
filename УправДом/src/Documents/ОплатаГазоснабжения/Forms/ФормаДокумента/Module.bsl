...
Процедура СозданиеГруппПрисоединенныхФайлов()
	...
	ИмяСправочника = "ОплатаГазоснабженияПрисоединенныеФайлы"; // Имя справочника для этого документа
...
Процедура ПриОткрытииНаСервере()
	...
	Иначе 
	//	возврат не делаем так как для логики эти данные не нужны, это просто реквизиты формы	
		Сообщение = Новый СообщениеПользователю;
