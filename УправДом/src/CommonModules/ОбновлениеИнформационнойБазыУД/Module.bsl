...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя    = "УправДом";
	Описание.Версия = "1.0.1.6";
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	 ...
	 Обработчик.Процедура           = "ОбновлениеИнформационнойБазыУДРеализация.АктуализироватьВидыКонтактнойИнформации";
	 Обработчик.РежимВыполнения = "Оперативно";
	 Обработчик.Идентификатор = "4f938422-0b25-4ee5-b8fb-564ba97ed83b";
	 Обработчик.Комментарий = НСтр("ru = 'Обновление свойств предопределенных элементов видов контактой информации.'");
