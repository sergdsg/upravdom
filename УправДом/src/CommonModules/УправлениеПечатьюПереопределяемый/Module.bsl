...
Процедура ПриОпределенииНастроекПечати(Настройки) Экспорт
	...
	Настройки.ОбъектыПечати.Добавить(Документы.ОплатаГазоснабжения);
	Настройки.ОбъектыПечати.Добавить(Документы.ОплатаЭлектроснабжения);
	Настройки.ОбъектыПечати.Добавить(Документы.ОплатаТКО);
	Настройки.ОбъектыПечати.Добавить(Документы.ОплатаИнтернет);
	Настройки.ОбъектыПечати.Добавить(Справочники.СоставСемьи);
...
Процедура ПриПолученииПодписейИПечатей(Документы, ПодписиИПечати) Экспорт
	...
	Собственник = Константы.СобственникУД.Получить();
	
		Если Не Собственник.Пустая() Тогда	
			СобственникПлательщик = Справочники.СоставСемьи.НайтиПоНаименованию(Собственник);
			КомплектПодписейИПечатей = Справочники.СоставСемьи.ПолучитьПодписиИПечати(СобственникПлательщик);
