...
//	Вывод документа на печать
	...
	ВозрастПредставление = РаботаСДатамиКлиентСервер.РассчитатьВозраст(ДанныеЗаполненияШапка.ДатаРождения);
	...
	ДанныеЗаполненияПодвал.Вставить("Адрес",Константы.Адрес.Получить());
